...
if (isset($_POST['submit'])) {
    ...
    if (move_uploaded_file($_FILES["pic"]["tmp_name"], $target_file)) {
        $sql = "INSERT INTO slider (slidername, sliderorder, pic) VALUES ('$slidername', '$sliderorder', '$target_file')";
                        ...
                        <div class="card-body">
                            ...
                            <form action="slider.php" method="post" enctype="multipart/form-data">
                                <div class="form-group mt-3">
                                    ...
                                    <input type="text" id="slidername" name="slidername">
                                </div>
                                <div class="form-group mt-3">
                                    <label for="username">Slider Order</label>
                                    <input type="text" id="sliderorder" name="sliderorder">
                                </div><br>
